...
class SipOutboundApi extends base.Api {
    ...
    deleteConfig(name, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const getResponse = yield this.api.apiV1SipOutboundByNameGet(name, {
            ...
            yield this.api.apiV1SipOutboundIdDelete(getResponse.data.id, {
    ...
    createConfig(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.api.apiV1SipOutboundPost(request, {
    ...
    getConfigByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.api.apiV1SipOutboundByNameGet(name, {
                validateStatus: (status) => status < 400 || status === 404,
            });
    ...
    listConfigs() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.api.apiV1SipOutboundGet(undefined, // skip
            undefined, // take
            {
                validateStatus: (status) => status < 400,
            });
    ...
    updateConfig(name, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const patchResponse = yield this.api.apiV1SipOutboundIdPatch(getResponse.data.id, request, {
                validateStatus: (status) => status < 400,
            });
